            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-md-0 mb-lg-0">
                        ...
                        <p class="mb-2"><strong class="d-inline me-2">Phone:</strong>  (+961) 70 21 33 52</p>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-9 col-12">
                        <ul class="site-footer-links">
                            ...
                            <li class="site-footer-link-item">
                                <a href="index.html" class="site-footer-link">Help Center</a>
                            </li>
                    ...
                    <div class="col-lg-3 col-12">
                        <p class="copyright-text mb-0">Copyright © 2023 CJ Resume
                        <br><br>
