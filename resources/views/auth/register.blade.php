    ...
    <div class="row justify-content-center">
        <div class="col-sm-12 col-md-6 px-0">
            ...
            <div class="login-poster">
                ...
                <p class="text-white mb-3 lead"><i class="fas fa-angle-right"></i> Trusted Job Portal to give you what you need</p>
            </div>
        </div>
        ...
        <div class="col-sm-12 col-md-6 px-0">
            <div class="login-container">
                <div class="login-header mb-3">
                    <h3><img src="{{asset('images/logo/Jobs.png')}}" width="50px;" alt=""> Create your account now</h3>
